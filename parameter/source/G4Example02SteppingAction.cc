...
//____________________________________________________________________________..
bool G4Example02SteppingAction::UserSteppingAction(const G4Step* aStep, bool was_used)
{
...
void G4Example02SteppingAction::SetInterfacePointers(PHCompositeNode* topNode)
{
  ...
  if (!m_HitContainer)
  {
    std::cout << "G4Example02SteppingAction::SetTopNode - unable to find " << hitnodename << std::endl;
  }
}

...
//_______________________________________________________________________
int G4ExampleSubsystem::InitRunSubsystem(PHCompositeNode *topNode)
{
...
//_______________________________________________________________________
int G4ExampleSubsystem::process_event(PHCompositeNode *topNode)
{
